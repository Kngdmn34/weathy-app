...
export default function Home() {
  ...
  <main className='relative bg-transparent pt-6'>
      ...
      <div className=" max-w-[40%] mx-auto grid-cols-2 gap-2 ">
        ...
        <div className=" relative ">
          ...
          <input className="relative mt-6 p-2 block justify-center items-center w-full rounded-md ring-1  ring-black hover:ring-blue=400 hover:shadow-lg focus:shadow-xl outline-none "
       ...
       <ClockUi /> 
        ...
        <div className="bg-gray-200 mt-11 p-4 rounded-md  border-2 border-white">
          <div className="flex justify-between font-thin text-7xl  tracking-widest p-12 ">
            {Math.round(wheather?.main?.temp)} °C 
            
        <div className=' text-3xl flex items-center font-light tracking-wide border-l border-black pl-6 transition ease-in-out delay-700'>
         
            
          <div className='relative mr-6 '>
            {getWeatherIcon(wheather?.weather[0]?.main) }
          </div>
           <div className=' mr-6 '>{wheather?.weather[0]?.main}</div>
        </div>  
          </div>
        ...
        <div className=' text-3xl flex items-center font-light tracking-wide border-l border-black pl-6'>
        <div>
        <Cloudy  size={70} style={{transition: '1s ease-in-out' }} />
          ...
          <div className='border-b border-black rounded-full mt-6 '></div>
          <ClockUi id='2' />
          <div className='bg-gray-200 flex flex-col-2 justify-between mt-11 p-4 rounded-md text-black border-white border-2 mb-4'>
          
            
                <div className='border-r border-black rounded-md m-2 p-3 grid justify-center'><div className='flex items-center p-2' ><Wind size={30}/><span className='p-2'>:</span><div className='flex p-2 py-4 items-center'>{wheather && Object.keys(wheather).length !== 0 ? wheather?.wind?.speed + `${'Km/h'}`: '--'} </div></div></div>
                <div className='border-l border-black border-r rounded-md m-2 p-6 grid justify-center items-center'><div className='flex items-center p-2' >
                
                  <Droplets  size={30}/> <span className='p-2'>:</span><div className='flex p-2 py-4 items-center'>{wheather && Object.keys(wheather).length !== 0 ? wheather?.main?.humidity + `${'%'}`: '--'} </div></div></div>
